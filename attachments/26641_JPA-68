...
@ComponentScan(
	    basePackages = {
	    		"com.airfrance.ndatabase.entity.pu1", 
	    		"com.airfrance.ndatabase.service.pu1", 
	    		"com.airfrance.ndatabase.repository.pu1"
	    		},
	        excludeFilters = @Filter(type = FilterType.ANNOTATION, value = Configuration.class))
@EnableTransactionManagement
@EnableJpaRepositories(
		transactionManagerRef 	= "1_transactionManager", 
		basePackages 			= "com.airfrance.ndatabase.repository.pu1", 
		entityManagerFactoryRef = "1_entityManagerFactory"
		)

public class PersistentUnit_1Configuration {
	 ...
	 */
	@Bean(name="1_persitenceUnitManager")
	public DefaultPersistenceUnitManager persistenceUnitManager() {
		...
		defaultPersistenceUnitManager.setDefaultPersistenceUnitName("1_persistenceUnit");
	 ...
	 * @return the persistence unit manager.
	 */
	@Bean(name="1_entityManagerFactory")
	 ...
	 * @return the persistence unit manager.
	 */
	@Bean(name="1_transactionManager")
